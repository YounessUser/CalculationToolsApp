...
/**
 * Created by youness on 2017-08-10.
 */

public class SendIdDepartement extends AsyncTask<Long,Void,String> {
    @Override
    protected String doInBackground(Long... params) {
        ...
        HttpPost post=new HttpPost("http://"+ Configuration.local+":8080/kt_FST_2/webresources/Departement/ByAnuelle");
